      ...
      <section className="bg-gradient-to-br from-sea-50 via-white to-ocean-50 py-16 lg:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="mt-4 text-sea-600 max-w-xl mx-auto">
            Order, reserve, or just say hello — we&apos;re here for you
          </p>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
            <div className="space-y-8">
              <div className="bg-gradient-to-br from-green-50 to-green-100 border border-green-200 rounded-2xl p-8 text-center">
                ...
                <h2 className="text-2xl font-serif font-bold text-green-800 mb-2">
                  Order or Reserve via WhatsApp
                </h2>
                <p className="text-green-600 text-sm mb-6">
                  Fastest response. Send us a message and we&apos;ll take it from there.
                </p>
                <a
                ...
                <div className="space-y-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-sea-500">Iyana Anfani Round About, 26 MKO Abiola Way, Anfani Rd, Ringroad, Ibadan</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
            ...
            <div>
              <h2 className="text-2xl font-serif font-bold text-sea-800 mb-6">
                Reserve a Table (In-Restaurant)
              </h2>
              <p className="text-sm text-sea-500 mb-6">
                Prefer to dine with us? Fill in the form and we&apos;ll confirm your
                reservation.
              </p>
              {submitted ? (
