      ...
      <section className="bg-gradient-to-br from-sea-50 via-white to-ocean-50 py-16 lg:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="mt-6 inline-flex items-center gap-2 bg-green-50 border border-green-200 text-green-700 px-4 py-2 rounded-full text-sm">
            ...
            All orders via WhatsApp — 0706 227 0224
          </div>
        </div>
      </section>
            ...
            <div key={category.name}>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                {category.items.map((item) => (
                  ...
                  >
                    {item.image && (
                      <div className="sm:w-36 h-36 shrink-0 overflow-hidden bg-sea-50">
                        <img
                          src={item.image}
                          alt={item.name}
                    ...
                    <div className="flex-1 flex flex-col p-4 justify-between min-w-0">
                      <div>
                        <div className="flex justify-between items-start gap-2">
                          <h3 className="font-semibold text-sea-800 text-sm leading-snug">
                            {item.name}
                          </h3>
                          <span className="text-base font-bold text-sea-600 whitespace-nowrap shrink-0">
                      ...
                      <div className="mt-2 pt-2 border-t border-sea-50 flex justify-end">
                        <a
